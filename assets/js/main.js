...
(function () {
  ...
  var ZH = {
    ...
    'pub.lead': '我在 <strong>金融时报 50 强（FT50）</strong>与 <strong>UT Dallas 24 强</strong>期刊上发表的论文优先展示，其后是我在<strong>顶级实证供应链管理期刊</strong>（SCM Journal List）上的论文。完整记录——40 余篇期刊论文、社论、教学案例与在研项目——可在下方展开。',
    ...
    'feat.scm': '重点展示 — 顶级实证供应链期刊（SCM Journal List）',
    ...
    'personal.3.h': '绘画',
    'personal.3.p': '绘画是我面对数据与截止日期时安静的调剂：一种更慢、亲手去观察与创作的方式。',
    'personal.4.h': '园艺',
